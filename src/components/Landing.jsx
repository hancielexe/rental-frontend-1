      ...
      <div class="max-w-screen-xl px-4 py-32 sm:px-6 lg:px-8" id="section">
                ...
                >
                  <div class="mx-auto max-w-lg text-center lg:mx-0 lg:text-left">
                    <h2 class="text-3xl text-white font-extrabold sm:text-4xl">Marlyn's House Rental</h2>
                    ...
                    <Link to="/inquire">
                    <a
                      class="mt-8 inline-flex items-center rounded border border-indigo-600 bg-indigo-600 px-8 py-3 text-white hover:bg-indigo-700 hover:text-white focus:outline-none focus:ring active:text-indigo-500"
                    >
                  ...
                  <div class="grid grid-cols-2 gap-4 sm:grid-cols-3">
                    <a
                      ...
                      href="/accountant"
                    >
                        <h2 class="mt-2 text-white font-bold text-3xl">Sampaloc, Manila</h2>
                    </a>
                    ...
                    <a
                      ...
                      href="/accountant"
                    >
                        <h2 class="text-white mt-2 font-bold text-3xl">Quiapo, Manila</h2>
                    </a>
