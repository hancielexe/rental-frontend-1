...
function Navbar() {
  return (
    <header class="text-gray-700 shadow-lg hidden md:block">
      <div class="container mx-auto flex items-center h-20">
          ...
          <ul class="mx-auto flex items-center">
            <li class="p-5 xl:p-8 active">
              <NavLink
                ...
                to="/">
                <button
                  class="block h-16 border-b-4 border-transparent leading-[4rem] before:absolute before:top-14 before:h-0.5 before:w-12 before:scale-x-0 before:bg-indigo-600 before:transition hover:before:scale-x-100">
                  <span>Home</span>
                </button>
              </NavLink>
            </li>
            <li class="p-5 xl:p-8">
              <NavLink
                ...
                to="/inquire">
                <button
                  class="block h-16 border-b-4 border-transparent leading-[4rem] before:absolute before:top-14 before:h-0.5 before:w-14 before:scale-x-0 before:bg-indigo-600 before:transition hover:before:scale-x-100">
                  <span>Inquire</span>
                </button>
              </NavLink>
            </li>
            <li class="p-5 xl:p-8">
              <NavLink
                ...
                to="/listings">
                <button
                  class="block h-16 border-b-4 border-transparent leading-[4rem] before:absolute before:top-14 before:h-0.5 before:w-11 before:scale-x-0 before:bg-indigo-600 before:transition hover:before:scale-x-100">
                  <span>Units</span>
                </button>
              </NavLink>
            </li>
            <li class="p-5 xl:p-8">
              <NavLink
                ...
                to="/contact">
              <button
                class="block h-16 border-b-4 border-transparent leading-[4rem] before:absolute before:top-14 before:h-0.5 before:w-16 before:scale-x-0 before:bg-indigo-600 before:transition hover:before:scale-x-100">
                <span>Contact</span>
              </button>
              </NavLink>
            </li>
            ...
            <li class="p-5 xl:p-8">
              <NavLink
                ...
                to="/faq">
                <button
                  class="block h-16 border-b-4 border-transparent leading-[4rem] before:absolute before:top-14 before:h-0.5 before:w-10 before:scale-x-0 before:bg-indigo-600 before:transition hover:before:scale-x-100">
                  <span>FAQ</span>
                </button>
              </NavLink>
            </li>
        ...
        <NavLink
          ...
          <button class="relative items-center justify-start inline-block px-5 py-3 overflow-hidden font-bold rounded-full group">
            <span class="w-32 h-32 rotate-45 translate-x-12 -translate-y-2 absolute left-0 top-0 bg-gray-700 opacity-[3%]"></span>
            <span class="absolute top-0 left-0 w-48 h-48 -mt-1 transition-all duration-500 ease-in-out rotate-45 -translate-x-56 -translate-y-24 bg-gray-700 opacity-100 group-hover:-translate-x-8"></span>
            <span class="relative w-full text-left text-gray-700 transition-colors duration-200 ease-in-out group-hover:text-white">Login</span>
            <span class="absolute inset-0 border-2 border-gray-700 rounded-full"></span>
          </button>
        </NavLink>
      </div>
    </header>
