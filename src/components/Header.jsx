        ...
        <header class="absolute inset-x-0 top-0 text-white md:block">
            <div class="container mx-auto flex items-center h-20">
                <a href="" class="flex items-center justify-center">
                    ...
                    <span class="ml-2 text-xl font-inter font-bold tracking-tighter"><p class = "font-medium md:text-base">Marlyn's</p><p class = "-mt-2 text-xs md:text-2xl">House Rental</p></span>
                </a>
