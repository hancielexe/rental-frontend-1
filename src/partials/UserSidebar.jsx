        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      >
                        <path
                          className={`fill-current ${pathname === "/" || pathname.includes("user")
                              ? "text-indigo-500"
                              : "text-slate-400"
                            }`}
              ...
              {/* Profile */}
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200 ${pathname.includes("profile") && "bg-slate-900"
                  }`}
              >
                <NavLink
                  end
                  to="/profile"
                  className={`block text-slate-200 truncate transition duration-150 ${pathname.includes("profile")
                      ? "hover:text-slate-200"
                      : "hover:text-white"
                    }`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                        <path
                          className={`fill-current ${pathname.includes("profile")
                              ? "text-indigo-500"
                              : "text-slate-600"
                            }`}
                  ...
                  return (
                    <React.Fragment>
                      ...
                      <NavLink
                        ...
                        className={`block text-slate-200 truncate transition duration-150 ${pathname.includes("apartment")
                            ? "hover:text-slate-200"
                            : "hover:text-white"
                          }`}
                      >
                        <div className="flex items-center justify-between ">
                          <div className="flex items-center">
                            ...
                            >
                              <path
                                className={`fill-current ${pathname.includes("apartment")
                                    ? "text-indigo-300"
                                    : "text-slate-400"
                                  }`}
              ...
              {/* Utility */}
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200${pathname.includes("bill") && "bg-slate-900"
                  }`}
              >
                <NavLink
                  end
                  to="/bill"
                  className={`block text-slate-200 truncate transition duration-150 ${pathname.includes("bill")
                      ? "hover:text-slate-200"
                      : "hover:text-white"
                    }`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      >
                        <circle
                          className={`fill-current ${pathname.includes("bill")
                              ? "text-indigo-300"
                              : "text-slate-400"
                            }`}
                          cx="18.5"
              ...
              {/* Maintenance */}
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200 ${pathname.includes("maintenance") && "bg-slate-900"
                  }`}
              >
                <NavLink
                  end
                  to="/maintenance"
                  className={`block text-slate-200 truncate transition duration-150 ${pathname.includes("maintenance")
                      ? "hover:text-slate-200"
                      : "hover:text-white"
                    }`}
                >
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path
                        className={`fill-current ${pathname.includes("maintenance")
                            ? "text-indigo-500"
                            : "text-slate-600"
                          }`}
                        d="M1 3h22v20H1z"
              ...
              {/* Complaints */}
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200 ${pathname.includes("complaint") && "bg-slate-900"
                  }`}
              >
                <NavLink
                  end
                  to="/complaint"
                  className={`block text-slate-200 truncate transition duration-150 ${pathname.includes("complaint")
                      ? "hover:text-slate-200"
                      : "hover:text-white"
                    }`}
                >
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path
                        className={`fill-current ${pathname.includes("complaint")
                            ? "text-indigo-600"
                            : "text-slate-700"
                          }`}
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            >
                              <path
                                className={`fill-current ${pathname.includes("settings")
                                    ? "text-indigo-500"
                                    : "text-slate-600"
                                  }`}
