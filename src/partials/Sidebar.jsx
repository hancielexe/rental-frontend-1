    ...
    <div>
      ...
      >
        ...
        <div className="flex justify mb-10 pr-3 sm:px-1">
          ...
          <div>
            <p className='px-4 text-white font-extrabold'>ALIPUR</p><span className="px-4  font-semibold text-sm text-slate-500">Administrator</span>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex shrink-0 ml-2">
                            <svg className={`w-3 h-3 shrink-0 ml-1 transition duration-300 group-open:-rotate-180 fill-current text-slate-400 ${open && 'rotate-180'}`} viewBox="0 0 12 12">
              ...
              {/* Messages */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200${pathname.includes('messages') && 'bg-slate-900'}`}>
                <NavLink
                  end
                  to="/messages"
              ...
              {/* Inbox */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200 ${pathname.includes('inbox') && 'bg-slate-900'}`}>
                <NavLink
                  end
                  to="/inbox"
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200 hover:text-indigo-300">Tenant In & Out</span>
                  </div>
                </NavLink>
              </li>
              {/* Calendar */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200 ${pathname.includes('calendar') && 'bg-slate-900'}`}>
                <NavLink
                  end
                  to="/calendar"
