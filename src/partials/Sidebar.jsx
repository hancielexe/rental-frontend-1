        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              {/* Dashboard */}
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200 ${pathname.includes("dashboard") && "bg-slate-900"
                  }`}
              >
                <NavLink
                  end
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                        <path
                          className={`fill-current ${pathname === "/" || pathname.includes("dashboard")
                            ? "text-indigo-500"
                            : "text-slate-400"
                            }`}
              ...
              {/* User Management */}
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200 ${pathname.includes("adminregister") && "bg-slate-900"
                  }`}
              >
                <NavLink
                  end
                  to="/adminregister"
                  className={`block text-slate-200 truncate transition duration-150 ${pathname.includes("adminregister")
                    ? "hover:text-slate-200"
                    : "hover:text-white"
                    }`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                        <path
                          className={`fill-current ${pathname.includes("adminregister")
                            ? "text-indigo-500"
                            : "text-slate-600"
                            }`}
              ...
              {/* Settings */}
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200 ${pathname.includes("inquiries") && "bg-slate-900"
                  }`}
              >
                <NavLink
                  end
                  to="/inquiries"
                  className={`block text-slate-200 truncate transition duration-150 ${pathname.includes("inquiries")
                    ? "hover:text-slate-200"
                    : "hover:text-white"
                    }`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      >
                        <path
                          className={`fill-current ${pathname.includes("inquiries")
                            ? "text-indigo-500"
                            : "text-slate-600"
                            }`}
              ...
              {/* Billing */}
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200${pathname.includes("billing") && "bg-slate-900"
                  }`}
              >
                <NavLink
                  end
                  to="/billing"
                  className={`block text-slate-200 truncate transition duration-150 ${pathname.includes("billing")
                      ? "hover:text-slate-200"
                      : "hover:text-white"
                    }`}
                >
              ...
              {/* Tasks */}
              <SidebarLinkGroup activecondition={pathname.includes("contract")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 truncate transition duration-150 ${pathname.includes("contract")
                          ? "hover:text-slate-200"
                          : "hover:text-white"
                          }`}
                        onClick={(e) => {
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            >
                              <path
                                className={`fill-current ${pathname.includes("contract")
                                  ? "text-indigo-500"
                                  : "text-slate-600"
                                  }`}
              ...
              >
                <NavLink
                  ...
                  to="/mainteadmin"
                  className={`block text-slate-200 truncate transition duration-150 ${pathname.includes("mainteadmin")
                    ? "hover:text-slate-200"
                    : "hover:text-white"
                    }`}
                >
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path
                        className={`fill-current ${pathname.includes("mainteadmin")
                          ? "text-indigo-500"
                          : "text-slate-600"
                          }`}
                        d="M1 3h22v20H1z"
              ...
              {/* Job Board */}
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200${pathname.includes("complaintadmin") && "bg-slate-900"
                  }`}
              >
                <NavLink
                  end
                  to="/complaintadmin"
                  className={`block text-slate-200 truncate transition duration-150 ${pathname.includes("complaintadmin")
                    ? "hover:text-slate-200"
                    : "hover:text-white"
                    }`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      >
                        <path
                          className={`fill-current ${pathname.includes("complaintadmin")
                            ? "text-indigo-600"
                            : "text-slate-700"
                            }`}
