        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200 ${
                  pathname.includes("adminregister") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
                  to="/adminregister"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes("adminregister")
                      ? "hover:text-slate-200"
                      : "hover:text-white"
                  }`}
                >
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200 ${
                  pathname.includes("inquiries") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex shrink-0 ml-2">
                            <svg
                              className={`w-3 h-3 shrink-0 ml-1 transition duration-300 group-open:-rotate-180 fill-current text-slate-400 ${
                                open && "rotate-180"
                              }`}
                              viewBox="0 0 12 12"
                            >
              ...
              {/* Assets */}
              <SidebarLinkGroup activecondition={pathname.includes("assets")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/* Tenant in and out */}
              <SidebarLinkGroup
                activecondition={pathname.includes("tenantin_out")}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 truncate transition duration-150 ${
                          pathname.includes("tenantin_out")
                            ? "hover:text-slate-200"
                            : "hover:text-white"
                        }`}
                        onClick={(e) => {
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200 ${
                  pathname.includes("mainteadmin") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 duration-200${
                  pathname.includes("complaintadmin") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
                  to="/complaintadmin"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes("complaintadmin")
                      ? "hover:text-slate-200"
                      : "hover:text-white"
                  }`}
                >
