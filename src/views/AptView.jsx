    ...
    <div class="flex justify-center px-36 place-content-center mt-10">
                ...
                <div className="sm:flex">
                  ...
                  <div class="flex-1 ml-3">
                    ...
                    <p class="mt-1 text-sm text-gray-700">
                      Please click the Download APK link below to download the application used to see the AR View of the
                      apartment.
                    </p>
                  </div>
      ...
      <div>
        ...
        <div class="mt-4 sm:flex sm:items-center sm:justify-center sm:gap-4">
          <NavLink end to={`/roomview?id=${unitid}`}>
          ...
          <button class = "text-indigo-600 hover:text-purple-600 hover:underline font-semibold" onClick={handleDownload}>Download APK</button>
        </div>
      </div>
    </div>
  );
