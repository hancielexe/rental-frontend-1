      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden bg-gray-100">
        ...
        <div className="col-span-6 sm:col-span-4">
          <div className="max-w-xl mt-4">
            <h1 className="text-4xl mb-5 ml-2 font-extrabold px-5 text-transparent bg-clip-text bg-gradient-to-l from-indigo-800 via-blue-700 to-sky-600">
          ...
          <div className="relative mx-80 align-middle mb-10">
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody class="shadow-md hover:shadow-sm">
