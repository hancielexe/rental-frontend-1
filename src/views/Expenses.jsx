            ...
            <div class="mb-5 w-full max-w-2xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
              <header class="px-5 py-4 border-b border-gray-100">
                <div class="grid grid-cols-2">
                  ...
                  <div className="flex justify-end">
                    ...
                    <button
                      class="ml-2 px-5 py-2.5 font-medium bg-blue-50 hover:bg-blue-100 hover:text-blue-600 text-blue-500 rounded-lg text-sm"
              ...
              <div class="p-3">
                <div class="overflow-x-auto">
                  ...
                  {showForm ? (
                    <>
                      <div className="fixed inset-0 z-auto overflow-auto">
                        <div
                        ...
                        <div className="flex items-start min-h-screen px-6 py-12 my-12 ">
                          <div className="relative w-full max-w-lg p-8 mx-auto bg-white rounded-md shadow-lg">
                            <p class = "text-xl font-semibold tracking-wide">Billing</p>
