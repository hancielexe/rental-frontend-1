      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
          <div className="lg:col-span-4 lg:py-12">
            <p className="max-w-xl font-mono font-bold text-6xl">Contract</p>
          ...
          <div className="rounded-lg bg-white p-  8 shadow-lg lg:col-span-5 lg:p-12">
            <form action="" className="space-y-4">
              ...
              <div className="ml-4">
                <input
                  type="text"
                  className="border-none w-150"
                  placeholder="________________________"
                />
                , of legal age, Filipino Citizen, and with residence and postal
                address{" "}
                <input
                  type="text"
                  className="border-none w-150"
              ...
              <div className="ml-4">
                ...
                <select className="w-150 p-2 rounded-lg shadow-md appearance-none">
                  ...
                  <option value="option1" className="font-bold italic">
                    931 F. R. Hidalgo Street, Quiapo, Manila
                  </option>
                  <option value="option2" className="font-bold italic">
                    929 F. R. Hidalgo Street, Quiapo, Manila
                  </option>
                  <option value="option3" className="font-bold italic">
              ...
              <div className="ml-8">
                ...
                for a duration of SIX (6) Months from
              ...
              <div className="ml-8">
                ...
                to pay the LESSOR the monthly rental of
