            ...
            <div class="flex flex-wrap mb-24 -mx-4">
              <div class="w-full px-4 mb-8 md:w-1/2 md:mb-0">
                <div class="sticky top-0 overflow-hidden ">
                  <h2 className="mb-7 font-bold text-2xl text-gray-700 md:text-4xl">
                    Overview
                  </h2>
                  {/*<div class="group relative mb-6 lg:mb-10 lg:h-96">
                                        <img src={units.imagePath} alt="unit" className="object-fill h-full" />
                                        <div
                                            class="absolute top-0 left-0 w-full h-0 flex flex-col justify-center items-center bg-black opacity-0 group-hover:h-full group-hover:opacity-40 duration-500">
                                    ...
                                    <div class="flex-wrap hidden -mx-2 md:flex">
                                        <div class="w-1/2 p-2 sm:w-1/4">
                                            <a class="block border border-gray-200 hover:border-blue-400" href="#">
                                                <img class="object-contain w-full lg:h-28" src="" alt="" />
                                            </a>
                                        </div>
                                        <div class="w-1/2 p-2 sm:w-1/4">
                                            <a class="block border border-gray-200 hover:border-blue-400" href="#">
              ...
              <div class="w-full px-4 md:w-1/2">
                <div class="lg:pl-20">
                  <div class="mb-6 ">
                    <h2 class="max-w-xl mt-6 mb-6 text-xl font-extrabold leading-loose tracking-wide text-gray-700 md:text-5xl">
                      Apartment {units.unitnumber}
                    </h2>
                    <div class="flex flex-wrap items-center mb-6">
                      <a
                        class="mb-4 text-xs hover:text-blue-600 lg:mb-0"
                        href="https://www.google.com/maps/place/929r+FR+Hidalgo+St,+Quiapo,+Manila,+1001+Metro+Manila/@14.5979291,120.9812239,17z/data=!3m1!4b1!4m6!3m5!1s0x3397ca1cf1c37bdb:0x13ea85a8bbb8ee95!8m2!3d14.5979239!4d120.9837988!16s%2Fg%2F11q7bd5rfb"
                      >
                        {units.unitLocation}
                      </a>
                    </div>
                    <p class="inline-block text-4xl font-bold text-gray-700">
                      <span>₱{units.unitPrice}</span>
                  ...
                  <div class="py-6 mb-6 border-t border-b border-gray-200">
                    <p class="mb-4 text-lg font-bold text-gray-700">
                      Other Features
                    </p>
                  ...
                  <div class="flex gap-4 mb-6">
                    <Link
                      to="/inquire"
                      href="#_"
                      class="relative rounded px-5 py-2.5 overflow-hidden group bg-indigo-600 hover:bg-gradient-to-r hover:from-indigo-500 hover:to-indigo-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-indigo-400 transition-all ease-out duration-300"
                    >
