                            ...
                            <div class="w-full px-4 mb-8 md:w-1/2 md:mb-0">
                                <div class="sticky top-0 overflow-hidden ">
                                    ...
                                    <div className="relative">
                                        <img src="./src/assets/QR1.png"
                                            className = "mx-20"
                                            width={365}
                                        />
                                        <img className="absolute top-0 left-0 rounded-lg hover:opacity-25 transition-opacity duration-1000 ease-out w-150 h-180"
                                            src={units.imagePath}
                                        />
                                    </div>
                                    {/* 
                                ...
                                <div class="lg:pl-20">
                                    <div class="mb-6 ">
                                        ...
                                        <div class="flex flex-wrap items-center mb-6">
                                            <a class="mb-4 text-xs hover:text-blue-600 lg:mb-0" href="https://www.google.com/maps/place/929r+FR+Hidalgo+St,+Quiapo,+Manila,+1001+Metro+Manila/@14.5979291,120.9812239,17z/data=!3m1!4b1!4m6!3m5!1s0x3397ca1cf1c37bdb:0x13ea85a8bbb8ee95!8m2!3d14.5979239!4d120.9837988!16s%2Fg%2F11q7bd5rfb">
                                                {units.unitLocation}
                                            </a>
                                        </div>
